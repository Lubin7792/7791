<template>
    <Tabs :animated="false" type="card">
        <!-- 介质服务器 -->
        <TabPane label="介质服务器">
            <Table stripe highlight-row :row-class-name="rowMedium" :data="medium" :columns="mediums" height="720"></Table>
        ...
        <!-- 磁盘 -->
        <TabPane label="磁盘设备">
            <Table stripe highlight-row :data="disk" :row-class-name="rowDisks" :columns="disks" height="720"></Table>
        ...
        <!-- 磁带库 -->
        <TabPane label="磁带库设备">
            <Table stripe highlight-row :data="tape" :row-class-name="rowTape" :columns="tapes" @on-current-change="librayData" height="720"></Table>
